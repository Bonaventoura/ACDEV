<section>
    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <div class="user-info">
            <div class="image">
                <img src="{{ asset('assets/images/users_48px.png') }}" width="48" height="48" alt="User" />
            </div>
                ...
                <div class="btn-group user-helper-dropdown">
                    ...
                    <ul class="dropdown-menu pull-right">
                        ...
                        <li>
                            ...
                            <a href="javascript:void(0);" class="class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                    ...
                    <ul class="ml-menu">
                        <li>
                            <a href="{{ route('etats.index') }}">
                                <span>Etats de projets</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('types.index') }}" class="menu-toggle">
                                <span>Types de projets</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('partenaires.index') }}" class="menu-toggle">
                                <span>Nos partenaires</span>
                            </a>
                        </li>

                        <li>
                            <a href="{{ route('projets.index') }}" class="menu-toggle">
